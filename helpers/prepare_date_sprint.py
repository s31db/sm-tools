...
def sprint_dates(start_date: str, weeks: int = 1, frm: str = '%Y-%m-%d',
                 now: bool = False, limit: str = None, end_date: str = None) -> Generator[date, None, None]:
...
def add_dates(d, frm: str, limit_date: date, end_date: date) -> Generator[date, None, None]:
    while d <= end_date:
...
def test_sprint_dates_futur():
    assert [*sprint_dates('5022-11-04', 3)] == ['5022-11-04', '5022-11-05', '5022-11-06', '5022-11-07', '5022-11-08',
                                                '5022-11-12', '5022-11-13', '5022-11-14', '5022-11-15',
                                                '5022-11-18', '5022-11-19', '5022-11-20', '5022-11-21', '5022-11-22',
                                                '5022-11-25']


def test_sprint_dates_futur_added():
    assert [*sprint_dates('5022-11-04', 3, end_date='5022-11-30')] == [
        '5022-11-04', '5022-11-05', '5022-11-06', '5022-11-07', '5022-11-08',
        '5022-11-12', '5022-11-13', '5022-11-14', '5022-11-15',
        '5022-11-18', '5022-11-19', '5022-11-20', '5022-11-21', '5022-11-22',
        '5022-11-25', '5022-11-26', '5022-11-27', '5022-11-28', '5022-11-29']
