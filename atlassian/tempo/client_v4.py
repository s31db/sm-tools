...
class Tempo(RestAPIClient):
    ...
    def post(
        ...
        path_absolute = super().url_joiner(self._base_url, path)
        return super().post(
            path_absolute, data=data, params=params, headers=headers, trailing=trailing
        )
    ...
    def get_plans(
        ...
        generic_resource_ids=None,
        plan_ids=None,
        plan_item_ids=None,
        plan_item_types=None,
        planned_time_breakdown=None,
        updated_from=None,
    ):
        """
    ...
    def get_plan_for_user(
        ...
        return self.get_plans(
            ...
            planned_time_breakdown=planned_time_breakdown,
            date_from=date_from,
            date_to=date_to,
    ...
    def search_plans(
        ...
        return self.get_plans(
            ...
            generic_resource_ids=generic_resource_ids,
            plan_ids=plan_ids,
    ...
    def create_plan(
        ...
        plan_item_id,
        plan_item_type,
        planned_seconds_per_day,
        description=None,
        include_non_working_days=None,
        plan_approval_reviewer_id=None,
    ...
    def get_timesheet_approvals(
        self, date_from=None, date_to=None, user_id=None, team_id=None
    ):
        """
